...
The following steps will guide you to execute the files that are contained in HW1.zip folder.
...
Only in case of 7. Mix noise in color image along with PSNR
Write: <inputfile.raw> <outputfileofdenoisedimage.raw> <bytesPerPixel><imageWidth <imageHeight> <originalimage>
Press Enter.
//g++ -std=c++0x used for case 20 and 21
6. Then Choose one:

Starting
Choose one: 1. Color to Grayscale Conversion
2. CMY conversion
...
7. Enter the one you want to implement. Press Enter. The output will be saved in HW3. 
